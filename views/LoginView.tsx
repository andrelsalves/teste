...
export default function LoginView() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0b0f1a] flex flex-col items-center justify-center p-6 font-sans">
      ...
      {/* Login Card */}
      <div className="w-full max-w-[420px] bg-[#111625] border border-white/5 rounded-[40px] p-10 shadow-2xl relative overflow-hidden">
        {/* Glow effect sutil ao fundo do card */}
        <div className="absolute -top-24 -right-24 w-48 h-48 bg-emerald-500/5 blur-[100px]" />
        
        <form onSubmit={handleLogin} className="relative z-10">
          
          {/* Selector - Igual à foto */}
          ...
          <div className="space-y-6">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-[#10b981] hover:bg-[#059669] disabled:bg-slate-800 disabled:text-slate-600 text-[#080c16] font-black py-5 rounded-2xl shadow-[0_10px_30px_rgba(16,185,129,0.2)] uppercase text-[11px] tracking-[0.2em] transition-all hover:scale-[1.01] active:scale-[0.98] mt-4"
            >
